  ...
  <div style="border-top: 1px solid rgba(220, 220, 220, 0.765)">
    <t-menu theme="light" default-value="dashboard" :collapsed="collapsed">
      ...
      <t-submenu value="data-analysis" mode="popup">
        ...
        <t-menu-item value="data-analysis/flight-traffic" @click="handleMenuClick('data-analysis/flight-traffic')">航班流量统计</t-menu-item>
        <t-menu-item value="data-analysis/operation-efficiency" @click="handleMenuClick('data-analysis/operation-efficiency')">运行效率分析</t-menu-item>
        <t-menu-item value="data-analysis/delay-analysis" @click="handleMenuClick('data-analysis/delay-analysis')">延误原因分析</t-menu-item>
      </t-submenu>
      <t-submenu value="system-management" mode="popup">
        ...
        <t-menu-item value="system-management/user-manage" @click="handleMenuClick('system-management/user-manage')">用户管理</t-menu-item>
        <t-menu-item value="system-management/dept-manage" @click="handleMenuClick('system-management/dept-manage')">部门管理</t-menu-item>
        <t-menu-item value="system-management/system-settings" @click="handleMenuClick('system-management/system-settings')">系统设置</t-menu-item>
      </t-submenu>

            ...
            <t-form ref="form" :data="flightPlanEditFormData" :rules="FlightPlanEDIT_FORM_RULES" :label-width="100"
                ...
                <el-scrollbar height="380px" style="pEditing: 40px;">
                    ...
                    <t-form-item label="计划起飞时间" name="scheduledDepartureTime">
                        <t-date-picker enable-time-picker allow-input clearable v-model="flightPlanEditFormData.scheduledDepartureTime" placeholder="请选择计划起飞时间" />
                    </t-form-item>
                    <t-form-item label="计划到达时间" name="scheduledArrivalTime">
                        <t-date-picker enable-time-picker allow-input clearable v-model="flightPlanEditFormData.scheduledArrivalTime" placeholder="请选择计划到达时间" />
                    </t-form-item>
                    <t-form-item label="实际起飞时间" name="actualDepartureTime">
                        <t-date-picker enable-time-picker allow-input clearable v-model="flightPlanEditFormData.actualDepartureTime" placeholder="请选择实际起飞时间" />
                    </t-form-item>
                    <t-form-item label="实际到达时间" name="actualArrivalTime">
                        <t-date-picker enable-time-picker allow-input clearable v-model="flightPlanEditFormData.actualArrivalTime" placeholder="请选择实际到达时间" />
                    </t-form-item>

                    ...
                    <template #default="scope">
                        <div style="display: flex; align-items: center;flex-direction: column;">
                            <t-popconfirm theme="default" content="您想优先处理该进程单吗" :visible="visibleMap[scope.row.id]"
                                ...
                                <t-button @click="withdrawSelectedAreaEfps(scope.row.id)" size="small" theme="default">
                                    <template #icon>
...
import { useAreaEfpsStore, withdrawSelectedAreaEfps, search, filterTableData, handleProcessingEfpsFirst } from "@/stores/areaEfps-store";

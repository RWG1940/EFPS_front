<template>
    <div class="operations">
        ...
        <t-list style="max-height: 200px;background-color: rgba(240, 248, 255, 0);">
            <t-row class="rowContent">
                ...
                <t-row style="margin-top: 10px;" :gutter="5">
                    <t-col>指令区快捷：</t-col>
                    <t-col><t-select v-model="location" :options="instructionRecordOptions" placeholder="记录区" size="small"
                            style="width: 80px;"></t-select></t-col>
                    ...
                    <t-col><t-button size="small" @click="changeHight(0)">保持</t-button></t-col>
                    <t-col><t-button size="small" @click="changeHight(1)">上升</t-button></t-col>
                    <t-col><t-button size="small" @click="changeHight(2)">下降</t-button></t-col>
                </t-row>
                <t-row style="margin-top: 10px;" :gutter="5">
                    <t-col>航路区快捷：</t-col>
                    <t-col><t-select size="small" style="width: 80px;" placeholder="记录区" v-model="selectedRecordArea">
...
import {
    location, changeHight, useAreaEfpsStore, transferEfps, nowProcessingData, saveOperations, setCreateTime, sendFlyCommand, filterEfpsByStatusAndDate, recycleProcessingAreaEfps, withdrawAreaEfps, onAreaChange, setVIP, locationReportSave, setConflictFlag, setDiversion, setReturnflight
    , selectedArea, inputOperationsValue, selectedItem, inputHightValue, hightTypeRadio, selectedRecordArea, locationName, locationReport, flyCommand, itemOptions
} from '@/stores/areaEfps-store';
import { areaEfpsAreaOptions, recordAreaOptions, instructionRecordOptions } from '@/types/areaEfpsDataTypes';
import { ref } from 'vue';

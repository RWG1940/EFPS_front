        ...
        <div>
            ...
            <t-row class="rowContent">
                <t-col>管制指令:
                    ...
                    高度1：<span>{{ nowProcessingData[0]?.b21 }}</span>
                    高度2：<span>{{ nowProcessingData[0]?.b22 }}</span>
                    高度3：<span>{{ nowProcessingData[0]?.b23 }}</span>
...
import { useAreaEfpsStore, nowProcessingData } from '@/stores/areaEfps-store';
